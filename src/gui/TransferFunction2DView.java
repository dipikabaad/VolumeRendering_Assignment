...
public class TransferFunction2DView extends javax.swing.JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        double yposMinGradient = h - ed.triangleWidget.downGradient * binHeight;
        double yposMaxGradient = h - ed.triangleWidget.upGradient * binHeight;
        ...
        System.out.println("ypos mingrad maxgrad xpos w" +":"+ ypos+":" + yposMinGradient +":"+ yposMaxGradient+":" + xpos + ":" + w);
    }
        ...
        public void mouseDragged(MouseEvent e) {
            if (selectedBaseControlPoint || selectedRadiusControlPoint
                ...
                if (selectedBaseControlPoint) {
                    ...
                    ed.triangleWidget.downGradient = (short) (h - dragEnd.y / binHeight);
                } else if (selectedMaxGradientControlPoint) {
                    ed.triangleWidget.upGradient = (short) (h - dragEnd.y / binHeight);
                }
                ed.setSelectedInfo();
